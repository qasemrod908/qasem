...
from app import db
from app.models import Student, Enrollment, Lesson, Grade, Course, NotificationRecipient, Notification, Payment, InstallmentPayment, Attendance, User
    ...
    if request.method == 'POST':
        ...
        if 'photo' in request.files:
            ...
            if file and file.filename:
                ...
                file_path = os.path.join(current_app.config['UPLOAD_FOLDER'], 'students', unique_filename)
                os.makedirs(os.path.dirname(file_path), exist_ok=True)
                file.save(file_path)
                student.photo = f'uploads/students/{unique_filename}'
